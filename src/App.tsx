const STACK = [
  'TypeScript', 'React', 'Node.js', 'Fastify', 'PostgreSQL',
  'Redis', 'Docker', 'Vite', 'Vercel',
];
    ...
    <>
      <nav>
        <div className="nav-inner">
          <span className="nav-logo">daniel<span>.</span></span>
      ...
      <main>
        ...
        <div className="container">
          <div className="hero">
            ...
            <p>
              Desenvolvedor Full Stack com 7 anos de experiência, trabalhei em empresas
              como GFT e Vakinha construindo produtos digitais robustos. Gosto de criar
              apps que considero interessantes.
            </p>
                ...
                <div key={p.name} className="project-card">
                  <div className="project-top">
                    ...
                    <div className="project-links">
                      ...
                      <a className="project-link github-link" href={p.github} target="_blank" rel="noreferrer">
